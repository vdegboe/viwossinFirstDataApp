...
# Charger les données
df = pd.read_csv('data/Villas.csv')
...
# Layout du dashboard
app.layout = html.Div([
    html.H1('Dashboard Interactif des Villas au Sénégal', style={'textAlign': 'center', 'margin': '20px'}),
    ...
    # Table des données
    html.Div([
        html.H3('Détails des Villas', style={'textAlign': 'center'}),
...
def update_dashboard(selected_ville):
    ...
    scatter_fig = px.scatter(
        ...
        title='Superficie vs Nombre de Pièces des Villas',
